...
import { getInitials, PRIOTITYSTYELS } from "../utils";
...
const Activities = ({ activity, id, refetch }) => {
  ...
  const Card = ({ item }) => {
    return (
      <div className={`flex space-x-4`}>
        ...
        <div className="flex flex-col gap-y-1 mb-8 title">
  ...
  return (
    <div className="w-full flex gap-10 2xl:gap-20 min-h-screen px-10 py-8 bg-white shadow rounded-md justify-between overflow-y-auto tasks-tab">
      <div className="w-full md:w-1/2">
        <h4 className="text-gray-600 font-semibold text-lg mb-5 title">
          Activities
        </h4>
      ...
      <div className="w-full md:w-1/3">
        ...
        <div className="w-full flex flex-wrap gap-5">
          ...
          <Button
            ...
            label="Submit"
            onClick={handleSubmit}
            className="bg-blue-600 text-white rounded lists-tab"
          />
        </div>
      </div>
    </div>
  ...
  return (
    <div className="w-full flex flex-col gap-3 mb-4 overflow-y-hidden">
      ...
      <Tabs tabs={TABS} setSelected={setSelected}>
        {selected === 0 ? (
          <>
            <div className="w-full flex flex-col md:flex-row gap-5 2xl:gap-8 bg-white shadow rounded-md px-8 py-8 overflow-y-auto outlet-css">
              <div className="w-full md:w-1/2 space-y-8">
                <div className="flex items-center gap-5 tasks-tab">
                  <div
                    className={clsx(
                      "flex gap-1 items-center text-base font-semibold px-3 py-1 rounded-full lists-tab",
                  ...
                  <div className={clsx("flex items-center gap-2 lists-tab")}>
                ...
                <div className="flex items-center gap-8 p-4 border-y border-gray-200 tasks-tab">
                ...
                <div className="space-y-4 py-6 tasks-tab">
                  ...
                  <div className="space-y-3">
                    {task?.team?.map((m, index) => (
                      <div
                        key={index + m?._id}
                        className="flex gap-4 py-2 items-center border-t border-gray-200 lists-tab"
                      >
                        <div
                          className={
