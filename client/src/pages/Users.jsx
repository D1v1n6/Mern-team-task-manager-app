    ...
    <tr className="border-b border-gray-200 text-gray-600 hover:bg-gray-400/10">
      ...
      <td>
        <button
          ...
          className={clsx(
            "w-fit px-4 py-1 rounded-full lists-tab",
      ...
      <td className="p-2 flex gap-4 justify-end">
        <Button
          className="text-blue-600 hover:text-blue-500 font-semibold sm:"
          label="Edit"
          type="button"
  ...
  return isLoading ? (
    ...
    <div>
      <div className="w-full md:px-1 px-0 mb-6">
        <div className="flex items-center justify-between mb-8 title">
          <Title title="Team Members" />

          <Button
            label="Add New User"
            icon={<IoMdAdd className="text-lg" />}
            className="flex flex-row-reverse gap-1 items-center bg-blue-600 text-white rounded-md 2xl:py-2.5 input-container"
