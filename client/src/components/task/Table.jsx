...
const Table = ({ tasks }) => {
  ...
  const TableHeader = () => (
    <thead className="w-full border-b border-gray-300">
      <tr className="w-full  text-black  text-left">
        ...
        {/* <th className="py-2 sm:hidden">Assets</th> */}
  ...
  const TableRow = ({ task }) => (
    <tr className="border-b border-gray-200 text-gray-600 hover:bg-gray-300/10">
      ...
      <td className="py-2 flex gap-2 md:gap-4 justify-end outlet-css sm:hidden md:flex">
        <Button
  ...
  return (
    <>
      <div className="bg-white  px-2 md:px-4 pt-4 pb-9 shadow-md rounded  sm:tasks-tab">
